...
class ArticleModel {
  Future<Summary> getRandomArticleSummary() async {
    ...
    // Use the new Summary.fromJson from summary.dart
    return Summary.fromJson(jsonDecode(response.body) as Map<String, Object?>);
  }
}

// Summary class is now imported from summary.dart
...
class ArticleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        // spacing: 10, // Column does not have a spacing property, use SizedBox
        children: [
